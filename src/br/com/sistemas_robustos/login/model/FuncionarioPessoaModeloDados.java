 ...
 * @author felix
 */
public class FuncionarioPessoaModeloDados extends DefaultPessoaModeloDados{

    @Override
    protected void verificaSalario(float salario) {
        super.verificaSalario(salario); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    protected void verificarIdade(int idade) {
        super.verificarIdade(idade); //To change body of generated methods, choose Tools | Templates.
    }
